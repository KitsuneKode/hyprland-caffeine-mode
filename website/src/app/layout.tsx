...
export const metadata: Metadata = {
  ...
  description: "The ultimate idle inhibitor for Hyprland. Stop your screen from sleeping during critical tasks, videos, and compilations. Built with precision in Bash and Systemd.",
  keywords: ["hyprland", "idle inhibitor", "wayland", "caffeine mode", "waybar", "systemd", "hypridle", "linux desktop"],
  authors: [{ name: "kitsunekode" }],
  creator: "kitsunekode",
  openGraph: {
    title: "Hyprland Caffeine Mode",
    description: "Advanced Idle Inhibitor for Hyprland. Never let your screen sleep at the wrong time again. Syncs perfectly with Waybar and Systemd.",
